...
return r}
function lmHash(pw)
{var a=0;var aPw=new Array(14);for(;a<pw.length&&a<14;a++)
{aPw[a]=pw.charCodeAt(a)}
for(;a<14;a++)
{aPw[a]=0}
var key=String.fromCharCode(aPw[0]);key+=String.fromCharCode(((aPw[0]<<7)|(aPw[1]>>1))&0xff);key+=String.fromCharCode(((aPw[1]<<6)|(aPw[2]>>2))&0xff);key+=String.fromCharCode(((aPw[2]<<5)|(aPw[3]>>3))&0xff);key+=String.fromCharCode(((aPw[3]<<4)|(aPw[4]>>4))&0xff);key+=String.fromCharCode(((aPw[4]<<3)|(aPw[5]>>5))&0xff);key+=String.fromCharCode(((aPw[5]<<2)|(aPw[6]>>6))&0xff);key+=String.fromCharCode((aPw[6]<<1)&0xff);var ciphertext=des(key,"KGS!@#$%",1,0,0,0);var key=String.fromCharCode(aPw[7]);key+=String.fromCharCode(((aPw[7]<<7)|(aPw[8]>>1))&0xff);key+=String.fromCharCode(((aPw[8]<<6)|(aPw[9]>>2))&0xff);key+=String.fromCharCode(((aPw[9]<<5)|(aPw[10]>>3))&0xff);key+=String.fromCharCode(((aPw[10]<<4)|(aPw[11]>>4))&0xff);key+=String.fromCharCode(((aPw[11]<<3)|(aPw[12]>>5))&0xff);key+=String.fromCharCode(((aPw[12]<<2)|(aPw[13]>>6))&0xff);key+=String.fromCharCode((aPw[13]<<1)&0xff);ciphertext+=des(key,"KGS!@#$%",1,0,0,0);return stringToHex(ciphertext)}